...
$tabTroops = GUICtrlCreateTabItem("Troops")
	...
	$grpTroopComp = GUICtrlCreateGroup("Army Composition", $x - 20, $y - 20, 222, 55)
		$cmbTroopComp = GUICtrlCreateCombo("", $x, $y, 180, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			...
			GUICtrlSetData(-1, "Preset: Archers|Preset: Barbarians|Preset: Goblins|Preset: B.Arch|Preset: B.A.G.G.|Preset: B.A.Giant|Preset: B.A.Goblin|Preset: B.A.G.G.Wall|Use Barrack Mode|Custom Army|Full Dragons|Wiz+Balloon+Drag|Wiz+Arch+Minion|Arch+G+Healer+WallB|Arch+Bar+Gob+Hog", "Full Dragons")
	GUICtrlCreateGroup("", -99, -99, 1, 1)
	...
	$grpBarrackMode = GUICtrlCreateGroup("Barrack Mode", $x - 20, $y -20, 223, 75)
		...
		$cmbBarrack1 = GUICtrlCreateCombo("", $x + 10, $y, 75, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			...
			GUICtrlSetData(-1, "Barbarians|Archers|Giants|Goblins|Dragons|Wizards|Healers|Wall Breakers|Balloons", "Dragons") ; "Barbarians|Archers|Giants|Goblins"
		$y += 2
...
;        GUICtrlSetTip(-1, $txtTip)
	...
	$grpTroops = GUICtrlCreateGroup("Troops", $x - 20, $y - 20, 222, 105)
		...
		$lblBarbarians = GUICtrlCreateLabel("No. of Barrbarians.", $x + 25, $y, -1, -1)
		$txtBarbarians = GUICtrlCreateInput("0", $x + 130, $y - 5, 55, -1, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			GUICtrlSetTip(-1, "Enter the No. of Barrbarians to make.")
			GUICtrlSetLimit(-1, 3)
		...
		$lblArchers = GUICtrlCreateLabel("No. of Archers", $x + 25, $y, -1, -1)
		$txtArchers = GUICtrlCreateInput("0", $x + 130, $y - 5, 55, -1, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			GUICtrlSetTip(-1, "Enter the No. of Archers to make.")
			GUICtrlSetLimit(-1, 3)
			;GUICtrlSetOnEvent(-1, "lblTotalCount")
			GUICtrlSetState(-1, $GUI_DISABLE)
		...
		$lblGoblins = GUICtrlCreateLabel("No. of Goblins", $x + 25, $y, -1, -1)
		$txtGoblins = GUICtrlCreateInput("0", $x + 130, $y - 5, 55, -1, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			GUICtrlSetTip(-1, "Enter the No. of Goblins to make.")
			GUICtrlSetLimit(-1, 3)
			;GUICtrlSetOnEvent(-1, "lblTotalCount")
			GUICtrlSetState(-1, $GUI_DISABLE)
	...
	$x +=  227
	$y = 330
	$grpDarkTroops = GUICtrlCreateGroup("Add. Dark Troops", $x - 20, $y - 20, 223, 65)
		...
		$txtNumHogs = GUICtrlCreateInput("0", $x + 130, $y - 5, 55, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER))
			...
			GUICtrlSetState(-1, $GUI_DISABLE)
			$y+=50
			GUICtrlCreateGroup("Spell Factory",$x-20,$y-20,223,100)
			GUICtrlCreatePic (@ScriptDir & "\Icons\lights.jpg", $x, $y - 3, 22, 22)
			$lblspell = GUICtrlCreateLabel("No. of lighting spell:", $x + 25, $y, -1, -1)
			$txtspell_l = GUICtrlCreateInput("0", $x + 130, $y - 5, 55, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER))
			$y+=26
			GUICtrlCreatePic (@ScriptDir & "\Icons\healings.jpg", $x, $y - 3, 22, 22)
			$lblspell= GUICtrlCreateLabel("No. of healing spell:", $x + 25, $y, -1, -1)
			$txtspell_h = GUICtrlCreateInput("0", $x + 130, $y - 5, 55, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER))
			$y+=26
			GUICtrlCreatePic (@ScriptDir & "\Icons\rages.jpg", $x, $y - 3, 22, 22)
			$lblspell = GUICtrlCreateLabel("No. of rage spell:", $x + 25, $y, -1, -1)
			$txtspell_r = GUICtrlCreateInput("0", $x + 130, $y - 5, 55, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER))
