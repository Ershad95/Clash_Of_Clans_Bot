...
Func btnStart()
	...
	setLog("Edited by Ershad Roaufi",$COLOR_GREEN,"Verdana",10)
...
#ce
			...
			GUICtrlSetState($txtNumHealers, $GUI_DISABLE)
			GUICtrlSetState($txtNumBalloons, $GUI_DISABLE)

GUICtrlSetState($txtNumDragons, $GUI_DISABLE)
		Case 1
			GUICtrlSetState($cmbBarrack1, $GUI_DISABLE)
			GUICtrlSetState($cmbBarrack2, $GUI_DISABLE)
			GUICtrlSetState($cmbBarrack3, $GUI_DISABLE)
...
#ce
		...
		Case 9
		 ...
		 Case 10
		    ...
		    GUICtrlSetData($cmbBarrack1, "Dragons")
		    GUICtrlSetData($cmbBarrack2, "Dragons")
		    GUICtrlSetData($cmbBarrack3, "Dragons")
		    GUICtrlSetData($cmbBarrack4, "Dragons")
			...
			GUICtrlSetState($txtNumHogs, $GUI_DISABLE)
			GUICtrlSetState($txtNumHealers, $GUI_DISABLE)
			GUICtrlSetState($txtNumDragons, $GUI_ENABLE)
			GUICtrlSetState($txtNumBalloons, $GUI_DISABLE)
		 Case 11
			GUICtrlSetState($cmbBarrack1, $GUI_ENABLE)
			GUICtrlSetState($cmbBarrack2, $GUI_ENABLE)
		    ...
		    GUICtrlSetData($cmbBarrack1, "Wizards")
		    GUICtrlSetData($cmbBarrack2, "Dragons")
		    GUICtrlSetData($cmbBarrack3, "Balloons")
		    GUICtrlSetData($cmbBarrack4, "Dragons")
			GUICtrlSetState($txtBarbarians, $GUI_DISABLE)
			GUICtrlSetState($txtArchers, $GUI_DISABLE)
			GUICtrlSetState($txtGoblins, $GUI_DISABLE)
		 ...
		 Case 12
		    ...
		    GUICtrlSetData($cmbBarrack1, "Archars")
		    GUICtrlSetData($cmbBarrack2, "Minions")
		    GUICtrlSetData($cmbBarrack3, "Wizards")
		    GUICtrlSetData($cmbBarrack4, "Archers")
			GUICtrlSetState($txtBarbarians, $GUI_DISABLE)
			GUICtrlSetState($txtArchers, $GUI_ENABLE)
			GUICtrlSetState($txtGoblins, $GUI_DISABLE)
			GUICtrlSetState($txtNumGiants, $GUI_DISABLE)
		 ...
		 Case 13
		    ...
		    GUICtrlSetData($cmbBarrack1, "Archers")
		    GUICtrlSetData($cmbBarrack2, "Giants")
		    GUICtrlSetData($cmbBarrack3, "Wall Breakers")
		    GUICtrlSetData($cmbBarrack4, "Healers")
			GUICtrlSetState($txtBarbarians, $GUI_DISABLE)
			GUICtrlSetState($txtArchers, $GUI_ENABLE)
			GUICtrlSetState($txtGoblins, $GUI_DISABLE)
			GUICtrlSetState($txtNumGiants, $GUI_ENABLE)
			...
			GUICtrlSetState($txtNumMinions, $GUI_DISABLE)
			GUICtrlSetState($txtNumHogs, $GUI_DISABLE)
			GUICtrlSetState($txtNumHealers, $GUI_ENABLE)
			GUICtrlSetState($txtNumBalloons, $GUI_DISABLE)
			GUICtrlSetState($txtNumDragons, $GUI_DISABLE)
		 ...
		 Case 14
		    ...
		    GUICtrlSetData($cmbBarrack1, "Archers")
		    GUICtrlSetData($cmbBarrack2, "Goblins")
		    GUICtrlSetData($cmbBarrack3, "Barbarians")
		    GUICtrlSetData($cmbBarrack4, "Archers")
			GUICtrlSetState($txtBarbarians, $GUI_ENABLE)
			GUICtrlSetState($txtArchers, $GUI_ENABLE)
			GUICtrlSetState($txtGoblins, $GUI_ENABLE)
