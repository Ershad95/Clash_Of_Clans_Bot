...
Func Train()
	...
	if _GUICtrlComboBox_GetCurSel($cmbTroopComp) = 8 Or 10 Or 11 Or 12 Or 13 Or 14 then
		while isBarrack()
			_CaptureRegion()
			if $FirstStart then
				 Click(496, 197, 80,5)
			...
			Switch $barrackTroop[$brrNum-1]
				Case 0
						Click(220, 320,GUICtrlRead($txtBarbarians) , 10)
				Case 1
						Click(331, 320,GUICtrlRead($txtArchers), 10)
				Case 2
						Click(432, 320,GUICtrlRead($txtNumGiants) , 10)
				Case 3
						Click(546, 320,GUICtrlRead($txtGoblins) , 10)
				Case 4
						Click(581, 425, GUICtrlRead($txtNumDragons), 10)
			    Case 5
						Click(325, 425, GUICtrlRead($txtNumWizards), 10)
			    Case 6
					    Click(430, 425, GUICtrlRead($txtNumHealers), 10)
			    Case 7
						Click(640, 320,GUICtrlRead($txtNumWallbreakers) , 10)
			    Case 8
						Click(220, 425, GUICtrlRead($txtNumBalloons), 10)
			EndSwitch
...
;~ 			; SetLog("====== Barrack: " & $brrDarkNum & " ======", $COLOR_PURPLE)
		  ...
		  if $troopFirstMinion = 0 then
			...
			If _Sleep(500) Then ExitLoop
			   ...
			   If GUICtrlRead($txtNumHogs)>0 Then
				  Click(369, 366,GUICtrlRead($txtNumHogs),10)
				  EndIf
		  ...
		  IF GUICtrlRead($txtNumMinions)>0 Then
			 Click(225, 324,GUICtrlRead($txtNumMinions),10)
			 EndIf
