...
$sBotVersion = "v2.0"
$sBotTitle = "Clash Game Bot EDITED RAOUFI " & $sBotVersion
		...
		If $Is_ClientSyncError = False Then
			...
			DonateCC()
				...
				If $Restart = True Then ContinueLoop
				   ;"============================="
				  If _Sleep(1000) Then Return
				checkMainScreen(True)							;Create Spell
				CreateSpell()
				   ;==============================;
			Train()
...
Func Attack() ;Selects which algorithm
 ...
 Func pass()
  ...
  If $cf>3 Then
    ...
    Local $sPasswd = InputBox("Security Check", "Enter your password(just 3 times).", "", "*")

	IF $spasswd =="09216542893"  Then
	   MsgBox($MB_SYSTEMMODAL, "", "you regestered in clashbot edited....")
	Else
	   	   MsgBox($MB_SYSTEMMODAL, "", "your pass is incorrect...counter : "&$cf)
           $cf=$cf+1
		   pass()
